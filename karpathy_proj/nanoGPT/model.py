...
class GPT(nn.Module):
    ...
    def __init__(self, config):
        ...
        self.transformer = nn.ModuleDict(dict(
            ...
            ln_f = LayerNorm(config.embed_dim, bias=config.bias),
        ))
    ...
    def from_pretrained(cls, model_type, override_args=None):
        ...
        # n_layer, n_head and embed_dim are determined from model_type
        config_args = {
    ...
    def estimate_mfu(self, fwdbwd_per_iter, dt):
        ...
        cfg = self.config
        L, H, Q, T = cfg.n_layer, cfg.n_head, cfg.embed_dim//cfg.n_head, cfg.block_size

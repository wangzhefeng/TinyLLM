...
class DataLoader:
    def __init__(self, 
        ...
        # 构建 tokenizer 数据文件
        self.index_2_word_file = index_2_word_file
    ...
    def build_task2_dataset(self, text_list):
        """
    ...
    def build_word_2_index(self, all_text: List=None):
        # tokenzier dir
        tokenizer_dir = self.data_dir.joinpath("tokenizer_data")
        tokenizer_dir.mkdir(parents=True, exist_ok=True)
        # tokenizer model path
        index_2_word_path = tokenizer_dir.joinpath(self.index_2_word_file)
...
def main():
    ...
    output_text_file = "THUCNews.csv"
    output_task_file = "task2.csv"
    index_2_word_file = "index_2_word.txt"

    dataloader = DataLoader(
        data_dir=data_dir,
        output_text_file=output_text_file,
        output_task_file=output_task_file,
        index_2_word_file=index_2_word_file,
    )
    ...
    # word_2_index = dataloader.build_word_2_index(all_text)

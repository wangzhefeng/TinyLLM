...
def arg_parser():
    ...
    # data loader
    parser.add_argument('--root_path', type=str, required=True, default='./dataset/pretrain/', help='root path of the data file')
    parser.add_argument('--data_path', type=str, required=True, default='pretrain_data.csv', help='data file')
    parser.add_argument('--data', type=str, required=True, default='pretrain_data', help='dataset type')
